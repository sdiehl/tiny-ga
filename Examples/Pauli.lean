...
def main : IO Unit := do
  ...
  IO.println ""
  IO.println s!"Product e1·e2·e3 = {show3 (e1.gp (e2.gp e3))}  (= I, unit pseudoscalar)"
  IO.println s!"I·I              = {show3 (I.gp I)}             (squares to -1)"

  IO.println ""
  IO.println "Bivectors are unit imaginaries (the quaternions of 3D)."
  ...
  let k := e12
  IO.println ""
  IO.println "Quaternion identities (i = e23, j = e13, k = e12):"
  ...
  IO.println ""
  IO.println "Rotation as a versor: a 90° rotation in the e12-plane sends e1 to e2."
