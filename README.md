...
- [CMA.lean](Examples/CMA.lean) - $\mathrm{Cl}(2,4,0)$ conformal Minkowski algebra (twistor theory), 64 blades.
...
- [Oct.lean](Examples/Oct.lean) - $\mathrm{Cl}(8,0,0)$ 256-blade Euclidean algebra (Spin(8) triality, octonion-adjacent), demoing rotors at $N = 8$.
